...
function HomePage() {
  return (
    <div className="h-screen overflow-hidden text-slate-900">
      <div className="mx-auto bg-white max-w-3xl px-4 py-12 space-y-16 dark:text-slate-100 dark:bg-neutral-800 h-full overflow-y-auto">
        <header className="space-y-4">
          <div className="flex justify-between">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-300/60 px-3 py-1 bg-slate-900/10 text-slate-700 ml-auto hover:bg-[#4A7056]/50 transition dark:text-gray-300 dark:bg-[#4A7056]/40">
              <DarkModeToggle />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-600 leading-relaxed dark:text-neutral-100">
              ...
              的課程系統化學習前端技術，並以專案實作打造自己的作品集。專注在
              React 與前端體驗，目標成為能獨立完成產品的前端工程師。
            </p>
          </div>
        </header>
